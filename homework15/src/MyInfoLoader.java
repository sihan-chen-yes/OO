...
public class MyInfoLoader {
    ...
    private HashMap<String,UmlAttribute> id2InteractionAttr = new HashMap<>();
    
    private MyUmlCollaborationInteraction myUmlCollaborationInteraction = null;
    
    private MyUmlStandardPreCheck myUmlStandardPreCheck = null;
    ...
    public void loadAttribute() {
        for (UmlAttribute attribute : attributes) {
            ...
            if (id2Class.containsKey(parentId)) {
                ...
                if (myInterface != null) {
                    myInterface.addAttr(attribute);
                }
            } else {
                id2InteractionAttr.put(attribute.getId(),attribute);
            }
        }
    }
    ...
    public void loadAssociation() {
        for (UmlAssociation association : associations) {
            ...
            if (myClass1 != null) {
                myClass1.addOppositeEnds(end2.getName());
            }
            MyClass myClass2 = id2Class.get(reference2);
            if (myClass2 != null) {
                myClass2.addOppositeEnds(end1.getName());
            }
    ...
    public MyUmlStandardPreCheck getMyUmlStandardPreCheck() {
        if (myUmlStandardPreCheck == null) {
            myUmlStandardPreCheck = new MyUmlStandardPreCheck(myUmlClassModelInteraction,
                    myUmlStateChartInteraction,myUmlCollaborationInteraction);
        }
        return myUmlStandardPreCheck;
    }
}
