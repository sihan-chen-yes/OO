...
public class MyUmlGeneralInteraction implements UmlGeneralInteraction {
    ...
    public MyUmlGeneralInteraction(UmlElement...elements) {
        MyInfoLoader myInfoLoader = new MyInfoLoader();
        for (UmlElement element : elements) {
            myInfoLoader.loadElement(element);
        }
        myUmlClassModelInteraction = myInfoLoader.getMyUmlClassModelInteraction();
        myUmlStateChartInteraction = myInfoLoader.getMyUmlStateChartInteraction();
        myUmlCollaborationInteraction = myInfoLoader.getMyUmlCollaborationInteraction();
        myUmlStandardPreCheck = myInfoLoader.getMyUmlStandardPreCheck();
    }
    ...
    @Override
    public String getClassAttributeType(String className,
    ...
    public int getIncomingMessageCount(String interactionName,
        ...
        return myUmlCollaborationInteraction.getIncomingMessageCount(interactionName,lifelineName);
    }

    @Override
    public int getSentMessageCount(String interactionName,
                                   String lifelineName, MessageSort sort) throws
            InteractionNotFoundException, InteractionDuplicatedException,
            LifelineNotFoundException, LifelineDuplicatedException {
    ...
    public void checkForAllRules() throws PreCheckRuleException {
        ...
        UmlGeneralInteraction.super.checkForAllRules();
    }
    
    @Override
    public void checkForUml001() throws UmlRule001Exception {
        myUmlStandardPreCheck.checkForUml001();
    }
