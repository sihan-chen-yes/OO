...
public class MyClass {
    ...
    private ArrayList<String> oppositeEnds = new ArrayList<>();
    ...
    public ArrayList<String> getOppositeEnds() {
        return oppositeEnds;
    }
    
    public void addOppositeEnds(String name) {
        oppositeEnds.add(name);
    }
